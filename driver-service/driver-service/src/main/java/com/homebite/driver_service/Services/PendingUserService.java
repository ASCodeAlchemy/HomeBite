...
public class PendingUserService {
    ...
    public void savePendingUser(DriverDTO userDTO) throws Exception {
    ...
    public DriverDTO getPendingUser(String email) throws Exception {
        String key = "pendingUser:" + email.toLowerCase();
        String value = redisTemplate.opsForValue().get(key);
        if (value == null) return null;
        return objectMapper.readValue(value, DriverDTO.class);
    }
